...
def render_upload_section():
    # Ensure the CV upload box visually matches the job description box height
    st.markdown(
        """
        <style>
    ...
    # Use equal-width columns for action buttons so both buttons
    # have the same (smaller) width on the page.
